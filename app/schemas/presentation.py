...
class GenerateFromTextRequest(BaseModel):
    ...
    swagger_url: Optional[str] = Field(default=None, description="US #025 - Link do Swagger/Docs")
...
class FAQRequest(BaseModel):
    ...
    audience: str = Field(default="stakeholders",
                          description="Perfil do público (ex: clientes, diretoria, engenheiros)")
...
class DiagramRequest(BaseModel):
    diagram: str = Field(...,
                         description="Descrição textual ou DSL do diagrama de arquitetura (ex: PlantUML, Mermaid, texto livre)")
